...
for (t in 1:10) {
  ...
  for (i in 1:(n_col - 1) ) {
    ...
    normal_param_0[1, i] <- mean(feat_0)
    normal_param_0[2, i] <- sqrt(var(feat_0))
    normal_param_1[1, i] <- mean(feat_1)
    normal_param_1[2, i] <- sqrt(var(feat_1))
  }
